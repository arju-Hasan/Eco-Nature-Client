  ...
  return (
    <div className="border border-green-400 rounded-lg shadow-md overflow-hidden transform transition-all duration-300 hover:scale-105 hover:shadow-lg p-4">
      ...
      <div className="flex flex-col justify-between h-full">
        ...
        {/* Footer Button */}
        <div className="flex justify-center border-t-3 border-dotted border-green-500 mt-auto pt-5">
          <button
            onClick={handleUpvote}
            disabled={isVoting}
            className={`rounded-tr-4xl rounded-bl-4xl flex flex-col justify-center mb-15 items-center w-2/4 px-4 py-2 bg-green-600 text-white text-center font-medium cursor-pointer hover:bg-green-200 hover:text-green-600 hover:border-green-600 border transition-colors duration-300 ${
