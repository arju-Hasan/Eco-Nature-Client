    ...
    <Container>
      <div className="mx-auto px-4 py-10">
        <div className="text-center py-5 mb-6">
          <h2 className="text-3xl  text-green-600 font-bold">All Challenges</h2>
          <p className="p-2">
            🐱‍🏍 Take a Small Step Today, Create a Green Tomorrow.
          </p>
        </div>

        {/* Filters UI */}
        <div className="grid grid-cols-1 md:grid-cols-6 gap-4 mb-4 px-0 md:px-5">
          <input
            type="number"
