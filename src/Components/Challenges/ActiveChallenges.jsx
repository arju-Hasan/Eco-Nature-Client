        ...
        <section className="pt-12 text-center">
          ...
          <div className="mb-10">
            ...
            <p className="font-bold pb-3">
              🌿“Join the Active Challenge to take meaningful steps for the
              planet—small actions, big impact!”🌿
            </p>
          </div>
          ...
          {/* View All Button */}
          <div className="mt-5 mx-5 w-full flex justify-center">
            <Link to="/challenges" className="w-full flex justify-center">
              <span className="flex items-center gap-3 bg-green-600 text-white px-4 py-2 mb-5 rounded-xl hover:bg-white hover:text-green-600 hover:border-green-600 border transition-colors duration-300">
