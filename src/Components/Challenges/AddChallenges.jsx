...
import AddChallenge from "../../assets/add.png";
...
const AddChallenges = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const payload = {
      ...formData,
      createdBy: user.email, // Ensure correct user
    };
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 py-20">
      <div>
        <img className="mx-auto" src={AddChallenge} alt="" />
      </div>
      <div className="max-w-xl mx-auto p-6 border border-green-600 shadow-md rounded-lg">
        <h2 className="flex gap-3 justify-center items-center text-2xl text-center font-bold mb-6 text-[#34be2f]">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              />
              {errors.impactMetric && (
                <p className="text-red-500 text-sm">{errors.impactMetric}</p>
              )}
            </div>
