      ...
      <Container>
        <section className="py-12 text-center">
          <div className="mb-10">
            ...
            <p>Stay updated with the latest helpful tips and insights.</p>
          </div>

          {/* Challenge Cards */}
          <div className="grid  justify-center gap-6 grid-cols-1 md:grid-cols-2 lg:grid-cols-4 px-6 md:px-12">
            {recentTips.map((tip) => (
