...
const Footer = () => {
  return (
    <footer className=" bg-black/30 py-10">
      <div className="container mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <p className="text-sm leading-relaxed">
            Eco Tracker helps you monitor your environmental impact through
            smart insights, daily habits, and sustainable challenges. It
            empowers you to reduce waste, a more eco-friendly lifestyle
          </p>
        </div>
      ...
      <div className=" mt-10 border-t-3 border-dotted border-green-600 pt-5 text-center text-sm">
        <p>
          Copyright © {new Date().getFullYear()}EcoTrack All right reserved.
        </p>
        <p>
          Developed by —
          <Link to={"https://github.com/arju-Hasan"} className="text-[#0a05ff]">
            Arju Hasan
          </Link>
        </p>
      </div>
